...
const char *LegoRobotModule::getUID() { return "Lego_NXT_Module"; };
...
bool LegoRobot::connect() {
  lego_communication_library::NXT_brick ^ singletoneBrick =
      lego_communication_library::NXT_brick::getInstance();
  try {
...
void LegoRobot::axisControl(system_value axis_index, variable_value value) {
  switch (axis_index) {
    ...
    case 5: {  // setSpeedMotor A.B.C.D
      if (!is_locked) {
        lego_communication_library::NXT_brick::getInstance()->motorSetSpeed(
    ...
    case 9: {  // moveMotor A,B,C,D
      if (!is_locked) {
        lego_communication_library::NXT_brick::getInstance()->motorMoveTo(
  ...
  try {
    ...
    switch (functionId) {
      case 1: {
        ...
        isMotor(input1);
        lego_communication_library::NXT_brick::getInstance()->motorBrake(
            robot_index, input1);
      ...
      case 2: {
        wchar_t input1 = *(const char *)args[0];
        isMotor(input1);
        rez = lego_communication_library::NXT_brick::getInstance()
      ...
      case 3: {
        ...
        isMotor(input1);
        rez =
            lego_communication_library::NXT_brick::getInstance()->motorGetTacho(
                robot_index, input1);
        break;
      }
      case 4: {
      ...
      case 5: {
        wchar_t input1 = *(const char *)args[0];
        isMotor(input1);
        lego_communication_library::NXT_brick::getInstance()->motorOff(
            robot_index, input1);
      ...
      case 6: {
        wchar_t input1 = *(const char *)args[0];
        isMotor(input1);
        lego_communication_library::NXT_brick::getInstance()->motorResetTacho(
            robot_index, input1);
        break;
      }
      case 7: {
        ...
        variable_value *input2 = (variable_value *)(args[1]);
        isMotor(input1);
        lego_communication_library::NXT_brick::getInstance()->motorSetDirection(
      ...
      case 9: {
        ...
        variable_value *input4 = (variable_value *)(args[3]);
        if (input1 != input2) {
          lego_communication_library::NXT_brick::getInstance()->setTrackVehicle(
      ...
      case 10: {
        wchar_t input1 = *(const char *)args[0];
        isMotor(input1);
        lego_communication_library::NXT_brick::getInstance()->waitMotorToStop(
            robot_index, input1);
        break;
      }
      case 11: {
      ...
      case 14: {
        if (is_trackVehicleOn) {
          lego_communication_library::NXT_brick::getInstance()->trackVehicleOff(
              robot_index);
        } else {
          throw std::exception();
        };
      ...
      case 22: {
        ...
        isThreeMode(*input2);
        rez = lego_communication_library::NXT_brick::getInstance()
                  ->readHiTecColor(robot_index, *input1, *input2);
        break;
      }
      case 23: {
        variable_value *input1 = (variable_value *)args[0];
        rez = lego_communication_library::NXT_brick::getInstance()
                  ->readHiTecCompass(robot_index, *input1);
        break;
      }
      case 24: {
        variable_value *input1 = (variable_value *)args[0];
        rez =
            lego_communication_library::NXT_brick::getInstance()->readHiTecGyro(
                robot_index, *input1);
        break;
      }
      case 25: {
        ...
        isThreeMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readHiTecTilt(
                robot_index, *input1, *input2);
        break;
      }
      case 26: {
        ...
        isFiveMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readNXTColor(
                robot_index, *input1, *input2);
        break;
      }
      case 27: {
        ...
        isTwoMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readNXTLight(
                robot_index, *input1, *input2);
        break;
      }
      case 28: {
        ...
        isTwoMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readNXTSonar(
                robot_index, *input1, *input2);
        break;
      }
      case 29: {
        ...
        isTwoMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readNXTSound(
                robot_index, *input1, *input2);
        break;
      }
      case 30: {
        ...
        isTwoMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readNXTTouch(
                robot_index, *input1, *input2);
        break;
      }
      case 31: {
        ...
        isTwoMode(*input2);
        rez =
            lego_communication_library::NXT_brick::getInstance()->readRCXLight(
                robot_index, *input1, *input2);
        break;
      }
      case 32: {
        variable_value *input1 = (variable_value *)args[0];
        rez = lego_communication_library::NXT_brick::getInstance()
                  ->readRCXRotation(robot_index, *input1);
        break;
      }
      case 33: {
        variable_value *input1 = (variable_value *)args[0];
        ...
        isTwoMode(*input2);
        rez = lego_communication_library::NXT_brick::getInstance()
                  ->readRCXTemperature(robot_index, *input1, *input2);
        break;
      }
      case 34: {
        wchar_t input1 = *(const char *)args[0];
        variable_value *input2 = (variable_value *)args[1];
        isMotor(input1);
        rez = lego_communication_library::NXT_brick::getInstance()->isMotorRun(
            robot_index, input1, !!(*input2));
        break;
      }
    };
